    ...
    <div class="container-fluid">
        ...
        <div class="p-3 p-md-5">
          <div class="col-md-6 px-0">
            <h1 class="display-4 font-italic">DAFTAR USER</h1>
          </div>
        </div>
            ...
            <div class="card  mb-4 box-shadow h-md-250">
              <div class="card-body d-flex flex-column align-items-start">
                <table class="table" style="color: black;">
                    <tbody>
                      <?php 
                      $data = mysqli_query($dahkonek,"select * from user");
                      while($d = mysqli_fetch_array($data)){
                        ?>
                      <tr>
                        <th scope="row"><span class="dot"></th>
                        <td><?php echo $d['username']; ?></td>
                        <td><a href="hapus_user_admin.php?id_user=<?php echo $d['id_user'];?>" class="btn btn-primary btn-lg circle-btn">HAPUS </a></td>
                      </tr>
                      <?php 
                                }
                                ?>
